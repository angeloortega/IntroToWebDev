            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form class="form-signin" data-toggle="validator" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <div class="form-group form-label-group">
                                <input type="text" id="inputUser" name="username" class="form-control" placeholder="Username"
                                    pattern="^[_A-z0-9]{1,}$" data-error="Please enter your username" required>
                        ...
                        <hr class="my-4">
                        <p class="message">Not registered? <a href="register.html">Create an account</a> or <a
                                href="password.html">Change password</a></p>
                    </div>
                </div>
            </div>
        </div>
